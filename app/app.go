...
func New(
	...
	var (
		...
		keys  = sdk.NewKVStoreKeys(
			...
			vaulttypes.StoreKey, liquiditytypes.StoreKey, assettypes.StoreKey, oracletypes.StoreKey, nfttypes.StoreKey,
	...
	app.mm.SetOrderBeginBlockers(
		...
		authz.ModuleName, oracletypes.ModuleName, transferModule.Name(), assettypes.ModuleName, vaulttypes.ModuleName, nfttypes.ModuleName,
	...
	app.mm.SetOrderEndBlockers(
		...
		vaulttypes.ModuleName, nfttypes.ModuleName, wasmtypes.ModuleName, authtypes.ModuleName, slashingtypes.ModuleName, authz.ModuleName,
