...
var (
	pattern_Query_Collection_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"comdex", "nft", "v1beta1", "collections", "denom_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Denom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"comdex", "nft", "v1beta1", "denoms", "denom_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Denoms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"comdex", "nft", "v1beta1", "denoms"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NFT_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"comdex", "nft", "v1beta1", "denoms", "denom_id", "nfts", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_OwnerNFTs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"comdex", "nft", "v1beta1", "nfts", "denom_id", "owner"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Supply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"comdex", "nft", "v1beta1", "denoms", "denom_id", "supply"}, "", runtime.AssumeColonVerbOpt(true)))
)
